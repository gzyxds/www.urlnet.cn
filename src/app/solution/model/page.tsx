        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="flex flex-col gap-6 items-center max-w-4xl mx-auto">
            ...
            >
              ...
              <span className="text-xs text-gray-600 dark:text-gray-300">电商试衣换装 2.0 发布</span>
            </motion.div>
            ...
            >
              AI模特 <span className="text-primary">多场景切换</span>
            </motion.h1>
            ...
            >
              专为电商卖家打造的AI视觉优化解决方案，提升商品主图的吸引力与转化率。<br className="hidden sm:block" />无需复杂拍摄与高昂成本，通过AI技术实现商品一键适配模特上身与背景智能替换。
            </motion.p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-lg">
              集智能模特匹配、AI换背景、服装贴合处理于一体,为您提供一站式电商视觉优化解决方案
            </p>
          </div>
