      ...
      <div className="relative pt-24 pb-16 md:pt-32 md:pb-24 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="flex flex-col gap-6 items-center max-w-4xl mx-auto">
            ...
            >
              打造您的 <span className="text-primary">专属 AI 视频</span>
            </motion.h1>
            ...
            >
              新一代 AI 视频生成工具,输入文字描述或上传参考图即可快速生成视频。<br className="hidden sm:block" />支持多种视频比例和分辨率,让创作更简单,开启智能视频创作新时代。
            </motion.p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-lg">
              集文生视频、图生视频、多种分辨率于一体,为您提供一站式视频生成解决方案
            </p>
          </div>
