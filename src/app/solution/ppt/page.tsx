        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="flex flex-col gap-6 items-center max-w-4xl mx-auto">
            ...
            >
              ...
              <span className="text-xs text-gray-600 dark:text-gray-300">AI PPT 2.0 发布</span>
            </motion.div>
            ...
            >
              一键直出 <span className="text-primary">幻灯片</span>
            </motion.h1>
            ...
            >
              智能演示文稿制作工具，根据主题或大纲自动生成 PPT。<br className="hidden sm:block" />内置多种模板与图表，支持智能配色、字体搭配与动画效果优化。
            </motion.p>
