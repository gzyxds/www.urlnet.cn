---
title: "即梦AI视频"
summary: "智言AI Video 是一款集成于 智言AI 平台的 AI 视频生成插件，利用先进的即梦 AI（火山引擎）技术，支持文生视频、图生视频、多分辨率、多时长等功能，用户无需专业视频制作技能，仅通过文字描述或参考图片即可快速生成高质量 AI 视频。"

category: "AI视频"
tags: ["AI视频", "文生视频", "图生视频", "即梦AI", "火山引擎", "智言AI"]
...
**智言AI Video** 是一款集成于 智言AI 平台的 AI 视频生成插件。它利用先进的即梦 AI（火山引擎）技术，让用户无需任何专业视频制作技能，仅通过简单的文字描述或参考图片，即可快速生成高质量的 AI 视频。
