        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch min-h-[500px]">
          ...
          >
            <div className="relative w-full h-full">
              ...
              {/* 主图片容器 */}
              <div className="relative bg-white rounded-2xl shadow-lg overflow-hidden w-full h-full min-h-[400px] p-3 lg:p-0">
                <img 
                  src="/images/scenarios/About.webp"  
                  alt="AI科技团队" 
          ...
          >
                ...
                {stats.map((stat, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="group"
                    >
                      <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-3 border border-gray-100 hover:border-blue-200 transition-all duration-300 hover:shadow-lg">
                        <div className="flex items-center space-x-3">
                          <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow duration-300">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Button className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-6 py-2 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                了解更多
