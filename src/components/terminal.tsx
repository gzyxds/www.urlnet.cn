      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-10">
          ...
          >
            ...
            <div className="w-24 h-1 bg-[#015bfe] mx-auto mb-4"></div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {platforms.map((platform, index) => (
              <motion.div
                ...
                className="group"
              >
                <Card className="h-full border border-gray-100 bg-white hover:border-blue-200 transition-all duration-300 cursor-pointer shadow-sm hover:shadow">
                  <CardContent className="p-4 flex flex-col items-center justify-center">
                    <div className={`w-14 h-14 ${platform.color} rounded-lg flex items-center justify-center mb-3`}>
                      {platform.icon}
                    </div>
                    <h3 className="text-sm font-medium text-gray-800 text-center">{platform.title}</h3>
                  </CardContent>
                </Card>
              </motion.div>
            ))}
